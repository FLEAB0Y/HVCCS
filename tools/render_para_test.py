...
def setup_and_render(blend_file_path, output_path):
    ...
    print(f"渲染完成，耗时: {render_time:.2f} 毫秒")
    print(f"渲染完成，输出路径: {output_path}")

if __name__ == "__main__":
    # blend_file_path = "/home/ztw/HVCCS/data/female_test.blend"
    blend_file_path = "../Render_Avatar/female-sports2_52shape_key_rename.blend"
    # blend_file_path = "data/boy52blendshapes.blend"
    output_path_relative = "res/rendered_image.png"
